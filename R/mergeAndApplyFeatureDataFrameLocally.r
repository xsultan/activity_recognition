#' Merge session files into one data frame - on the raw files shipped with the package
#'
...
#'
#' @export
mergeAndApplyFeatureDataFrameLocally <- function(dataSource, stepsCycle, feature){
  ...
  results2$key <- rownames(results2)
